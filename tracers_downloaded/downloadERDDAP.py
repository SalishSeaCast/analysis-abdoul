...
if org == 'onc':
    ...
    name = '/ocean/atall/MOAD/Obs/ONC.p'
    df.to_pickle(name)
...
if org == 'ios':
    ...
    for i in range(len(times)-1):
        ...
        name = '/ocean/atall/MOAD/Obs/IOS_ctd_moor_'+times[i][:4]+'.p'
        df.to_pickle(name)
        print(name)
    ...
    for i in range(len(times)-1): 
        ...
        name = '/ocean/atall/MOAD/Obs/IOS_ctd_prof_'+times[i][:4]+'.p'
        df.to_pickle(name)
        print(name)
...
if org == 'ooi':
    ...
    name = '/ocean/atall/MOAD/Obs/OOI_nitrate.p'
    df.to_pickle(name)
    ...
    name = '/ocean/atall/MOAD/Obs/OOI_chlorophyll.p'
    df.to_pickle(name)
    ...
    name = '/ocean/atall/MOAD/Obs/OOI_oxygen.p'
    df.to_pickle(name)
    ...
    name = '/ocean/atall/MOAD/Obs/OOI_co2.p'
    df.to_pickle(name)